...
Customers scan a QR code and place an order from their phone browser. They enter their phone, table number, and whatever notes/special requests they want to make on their order.
...
cd client
npm install
npm run build (or run dev for only frontend)
